...
export const getTracingDataByCategory = (
  category: "number" | "letter",
  language: "en" | "uz" = "en",
) => {
  if (category === "number") {
    ...
    const letterPaths =
      language === "en" ? englishLetterPaths : uzbekLetterPaths;
...
function splitPathToSegments(pathData: string): {
  path: string;
...
export const getTracingSegmentsByCategory = (
  category: "number" | "letter",
  language: "en" | "uz" = "en",
) => {
  if (category === "number") {
